...
void queue_fill0_from_main_push_Save0(q_buffer _x1, MyState_compressed0* _x2) {
...
void queue_fork0_from_main_push_Save0(MyState_compressed0* _x3) {
...
void push(int arg0, uint8_t arg1) { main_push_Save0(arg0, arg1); }
