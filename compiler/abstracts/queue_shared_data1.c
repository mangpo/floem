...
rte_memcpy(e->key, _state->key, _state->keylen);
...
void queue_size_core0_from_save(_queue_fill0_from_save_join_buffer* _p_queue_fill0_from_save, mystate_compressed0* _x3) {
  ...
  queue_enq_alloc0_from_save(_p_queue_fill0_from_save, sizeof(entry_queue0) + _state->keylen, _state->core);
}

void save(int len,  uint8_t data) {
...
void push(int arg0, uint8_t arg1) { save(arg0, arg1); }
