...
- `@API_implicit_inputs(name, default_return=None)`
- `@API_implicit_outputs(name)`
- `@API_implicit_inputs_outputs(name)`
...
```
#### TODO
- triggers = true as default
- init(), run_threads(), kill_threads(), finalize_and_check()
#### Dependencies
