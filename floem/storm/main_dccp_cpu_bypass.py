...
bypass_get('bypass_get', process='dpdk')
bypass_advance('bypass_advance', process='dpdk')
...
#include "dccp.h"
'''
c.depend = {"test_storm_bypass": ['list', 'hash', 'hash_table', 'spout', 'count', 'rank', 'worker', 'dpdk']}
c.generate_code_as_header("dpdk")
c.compile_and_run([("test_storm_bypass", workerid[test])])
